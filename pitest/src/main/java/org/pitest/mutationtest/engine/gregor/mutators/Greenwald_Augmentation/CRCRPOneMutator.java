...
public class CRCRPOneMutator implements MethodMutatorFactory {

    private final class CRCRPOneMutatorVisitor extends MethodVisitor {
        private final MutationContext context;

        CRCRPOneMutatorVisitor(final MutationContext context, final MethodVisitor delegateVisitor) {
        ...
        private void mutate(final Double constant) {
            ...
            Double replacement = constant + 1.0;
        ...
        private <T extends Number> boolean shouldMutate(final T constant, final T replacement) {
            final MutationIdentifier mutationId = this.context.registerMutation(
                    CRCRPOneMutator.this, "CRCR - Substituted " + constant + " with " + replacement);
    ...
    public MethodVisitor create(final MutationContext context, final MethodInfo methodInfo, final MethodVisitor methodVisitor) {
        return new CRCRPOneMutatorVisitor(context, methodVisitor);
    }
