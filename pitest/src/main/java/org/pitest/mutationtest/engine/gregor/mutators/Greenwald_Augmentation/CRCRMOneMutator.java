...
public class CRCRMOneMutator implements MethodMutatorFactory {

    private final class CRCRMOneMutatorVisitor extends MethodVisitor {
        private final MutationContext context;

        CRCRMOneMutatorVisitor(final MutationContext context, final MethodVisitor delegateVisitor) {
        ...
        private <T extends Number> boolean shouldMutate(final T constant, final T replacement) {
            final MutationIdentifier mutationId = this.context.registerMutation(
                    CRCRMOneMutator.this, "CRCR - Substituted " + constant + " with " + replacement);
    ...
    public MethodVisitor create(final MutationContext context, final MethodInfo methodInfo, final MethodVisitor methodVisitor) {
        return new CRCRMOneMutatorVisitor(context, methodVisitor);
    }
