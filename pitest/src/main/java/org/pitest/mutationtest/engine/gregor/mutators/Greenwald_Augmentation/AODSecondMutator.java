 ...
 *
 * AOD Second Mutator -
 *    Mutator to replace an arithmetic operation by the second of the two operands
 */

//TODO Need to actually write this and not just copy the AODFirstMutator...
...
public enum AODSecondMutator implements MethodMutatorFactory {
...
class AODSecondMethodVisitor extends AbstractInsnMutator {
    ...
    AODSecondMethodVisitor(final MethodMutatorFactory factory, final MethodInfo methodInfo, final MutationContext context, final MethodVisitor writer) {
