...
public class CRCRRandomMutator implements MethodMutatorFactory {

    private final class CRCRRandomMutatorVisitor extends MethodVisitor {
        private final MutationContext context;

        CRCRRandomMutatorVisitor(final MutationContext context, final MethodVisitor delegateVisitor) {
    ...
    public MethodVisitor create(final MutationContext context, final MethodInfo methodInfo, final MethodVisitor methodVisitor) {
        return new CRCRRandomMutatorVisitor(context, methodVisitor);
    }
