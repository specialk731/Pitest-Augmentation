 ...
 *
 * CRCR Random Mutator -
 *    Mutator that replaces a variable a by 0, 1, a-1, a+1, -a randomly
 */
...
public class CRCRNegationMutator implements MethodMutatorFactory {

    private final class CRCRNegationMutatorVisitor extends MethodVisitor {
        private final MutationContext context;

        CRCRNegationMutatorVisitor(final MutationContext context, final MethodVisitor delegateVisitor) {
        ...
        private void mutate(final Double constant) {
            ...
            Double replacement = constant * Integer.valueOf(-1);
        ...
        private void mutate(final Float constant) {
            ...
            Float replacement = constant * Integer.valueOf(-1);
        ...
        private void mutate(final Integer constant) {
            Integer replacement = constant * Integer.valueOf(-1);
        ...
        private void mutate(final Long constant) {
            ...
            Long replacement =  constant * Integer.valueOf(-1);
        ...
        private <T extends Number> boolean shouldMutate(final T constant, final T replacement) {
            final MutationIdentifier mutationId = this.context.registerMutation(
                    CRCRNegationMutator.this, "CRCR - Substituted " + constant + " with " + replacement);
    ...
    public MethodVisitor create(final MutationContext context, final MethodInfo methodInfo, final MethodVisitor methodVisitor) {
        return new CRCRNegationMutatorVisitor(context, methodVisitor);
    }
