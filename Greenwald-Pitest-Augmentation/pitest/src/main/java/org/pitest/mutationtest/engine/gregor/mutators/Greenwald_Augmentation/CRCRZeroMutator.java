...
public class CRCRZeroMutator implements MethodMutatorFactory {

    private final class CRCRZeroMutatorVisitor extends MethodVisitor {
        private final MutationContext context;

        CRCRZeroMutatorVisitor(final MutationContext context, final MethodVisitor delegateVisitor) {
        ...
        private void mutate(final Integer constant) {
            Integer replacement = Integer.valueOf(0);
        ...
        private <T extends Number> boolean shouldMutate(final T constant, final T replacement) {
            final MutationIdentifier mutationId = this.context.registerMutation(
                    CRCRZeroMutator.this, "CRCR - Substituted " + constant + " with " + replacement);
    ...
    public MethodVisitor create(final MutationContext context, final MethodInfo methodInfo, final MethodVisitor methodVisitor) {
        return new CRCRZeroMutatorVisitor(context, methodVisitor);
    }
