...
public class CRCROneMutator implements MethodMutatorFactory {

    private final class CRCROneMutatorVisitor extends MethodVisitor {
        private final MutationContext context;

        CRCROneMutatorVisitor(final MutationContext context, final MethodVisitor delegateVisitor) {
        ...
        private void mutate(final Integer constant) {
            Integer replacement = Integer.valueOf(1);
        ...
        private <T extends Number> boolean shouldMutate(final T constant, final T replacement) {
            final MutationIdentifier mutationId = this.context.registerMutation(
                    CRCROneMutator.this, "CRCR - Substituted " + constant + " with " + replacement);
    ...
    public MethodVisitor create(final MutationContext context, final MethodInfo methodInfo, final MethodVisitor methodVisitor) {
        return new CRCROneMutatorVisitor(context, methodVisitor);
    }
